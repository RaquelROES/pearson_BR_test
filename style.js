(function (blink) {
	...
	var pearson_BR_testStyle = function () {
			blink.theme.styles.basic.apply(this, arguments);
		},
		page = blink.currentPage;

	pearson_BR_testStyle.prototype = {
		//BK-15873 añadimos el estilo basic como parent para la herencia de los estilos del CKEditor
		parent: blink.theme.styles.basic.prototype,
		bodyClassName: 'content_type_clase_pearson_BR_test',
		ckEditorStyles: {
		...
		formatCarouselindicators: function (scope, classNavbar) {
			var that = scope || this,
				navbar = ((typeof classNavbar !== "undefined" && classNavbar)?classNavbar:'pearson_BR_test-navbar'),
	...
	pearson_BR_testStyle.prototype = _.extend({}, new blink.theme.styles.basic(), pearson_BR_testStyle.prototype);

	blink.theme.styles['pearson_BR_test'] = pearson_BR_testStyle;
